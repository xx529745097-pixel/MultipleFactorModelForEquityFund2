...
def fstrat_getCC30ModelFinalProductList_changeable_diviation(
    ...
    product_score['score'] = (0.2*product_score['jensen_beta'] + 0.4*product_score['sharpe'] + 0.1*product_score['TM_gamma']
                              + 0.1*product_score['TM_alpha'] + 0.2*product_score['stability'])
    ...
    product_score_with_info_output.to_excel(fstrat_config.cc30_run_path+"智选30-基金打分结果_{}.xlsx".format(date))
    ...
    shortlist_res.to_excel(fstrat_config.cc30_run_path+"智选30-基金选择_{}.xlsx".format(date))
    return shortlist_res
